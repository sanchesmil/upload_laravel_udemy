                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          ...
                          <!-- Cria um form para o botão que deleta o card -->
                          <form method="post" action="/{{$post->id}}">  <!-- informa a rota / passando o id do arquivo -->
                            @csrf
                            <input type="hidden" name="_method" value="delete"> <!-- Altera o metodo para 'delete' -->
